...
namespace UIThemes.Editor
{
	...
	public static class MenuOptions
	{
		...
		{
			var settings = ThemesReferences.Default;
		...
		/// </summary>
		[MenuItem("GameObject/UI/UI Themes/Remove All ThemeTargets", false, 30)]
		public static void RemoveThemeTargets()
		{
			...
			Undo.RegisterFullObjectHierarchyUndo(target, "Undo Remove ThemeTargets");
		...
		/// </summary>
		[MenuItem("GameObject/UI/UI Themes/Remove ThemeTargets with Default Theme", false, 30)]
