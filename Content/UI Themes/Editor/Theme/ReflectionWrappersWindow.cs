...
namespace UIThemes.Editor
{
	...
	public partial class ReflectionWrappersWindow : EditorWindow
	{
		...
		{
			ThemesReferences.Default.WrappersFolder = WrappersFolder.value;
			ThemesReferences.Default.WrappersNamespace = WrappersNamespace.value;

			var gen = new WrappersGenerator(
				ThemesReferences.Default.WrappersFolder,
				ThemesReferences.Default.WrappersNamespace,
		...
		protected virtual VisualElement CreateGeneratorBlock()
		{
			...
			{
				value = ThemesReferences.Default.WrappersFolder,
			};
			...
			{
				value = ThemesReferences.Default.WrappersNamespace,
			};
			WrappersFolder.AddToClassList("wrappers-generate-input");
