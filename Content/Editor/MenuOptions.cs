...
namespace UIWidgets
{
	...
	public static class MenuOptions
	{
		...
		/// Create DatePicker.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/DatePicker", false, 3000)]
		...
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/DateTimePicker", false, 3005)]
		...
		/// Create Dialog.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/Dialog", false, 3010)]
		...
		/// Create FileDialog.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/FileDialog", false, 3020)]
		...
		/// Create FolderDialog.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/FolderDialog", false, 3030)]
		...
		/// Create Notify.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/Notification", false, 3040)]
		...
		/// Create PickerBool.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/PickerBool", false, 3050)]
		...
		/// Create PickerIcons.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/PickerListViewIcons", false, 3060)]
		...
		/// Create PickerInt.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/PickerInt", false, 3070)]
		...
		/// Create PickerString.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/PickerString", false, 3080)]
		...
		/// Create Popup.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/Popup", false, 3090)]
		...
		/// Create TimePicker.
		/// </summary>
		[MenuItem("GameObject/UI/New UI Widgets/Dialogs Templates/TimePicker", false, 3100)]
		...
		{
			Create(PrefabsMenu.Instance.Rating);
		}
		...
		{
			Create(PrefabsMenu.Instance.LoadingAnimation);
		}
