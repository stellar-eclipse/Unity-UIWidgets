	...
	public class ResizableHandles : UIBehaviourConditional
	{
		...
		public virtual bool IsControlled(GameObject go)
		{
			...
			return Utilities.IsSame(id, Target.gameObject)
				|| Utilities.IsSame(id, TopLeft?.gameObject)
				|| Utilities.IsSame(id, TopCenter?.gameObject)
				|| Utilities.IsSame(id, TopRight?.gameObject)
				|| Utilities.IsSame(id, MiddleLeft?.gameObject)
				|| Utilities.IsSame(id, MiddleRight?.gameObject)
				|| Utilities.IsSame(id, BottomLeft?.gameObject)
				|| Utilities.IsSame(id, BottomCenter?.gameObject)
				|| Utilities.IsSame(id, BottomRight?.gameObject);
		}
